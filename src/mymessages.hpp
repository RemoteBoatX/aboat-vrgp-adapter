...
class LIB_API VoltageReading {
    ...
    public:
        inline VoltageReading& torque(const float &v) noexcept {
            m_torque = v;
            return *this;
        }
        inline float torque() const noexcept {
...
class LIB_API WeightReading {
    ...
    public:
        inline WeightReading& torque(const float &v) noexcept {
            m_torque = v;
            return *this;
        }
        inline float torque() const noexcept {
...
class LIB_API VoltageRequest {
    ...
    public:
        inline VoltageRequest& torque(const float &v) noexcept {
            m_torque = v;
            return *this;
        }
        inline float torque() const noexcept {
...
class LIB_API GroundSurfaceArea {
    ...
    public:
        ...
        inline GroundSurfaceArea& leftPerpendicularAngle(const float &v) noexcept {
            m_leftPerpendicularAngle = v;
            return *this;
        }
        inline float leftPerpendicularAngle() const noexcept {
            return m_leftPerpendicularAngle;
        }
        inline GroundSurfaceArea& leftDistance(const float &v) noexcept {
            m_leftDistance = v;
            return *this;
        }
        inline float leftDistance() const noexcept {
            return m_leftDistance;
        }
        inline GroundSurfaceArea& rightPerpendicularAngle(const float &v) noexcept {
            m_rightPerpendicularAngle = v;
            return *this;
        }
        inline float rightPerpendicularAngle() const noexcept {
            return m_rightPerpendicularAngle;
        }
        inline GroundSurfaceArea& rightDistance(const float &v) noexcept {
            m_rightDistance = v;
            return *this;
        }
        inline float rightDistance() const noexcept {
            return m_rightDistance;
        }
        inline GroundSurfaceArea& nearPerpendicularAngle(const float &v) noexcept {
            m_nearPerpendicularAngle = v;
            return *this;
        }
        inline float nearPerpendicularAngle() const noexcept {
            return m_nearPerpendicularAngle;
        }
        inline GroundSurfaceArea& nearDistance(const float &v) noexcept {
            m_nearDistance = v;
            return *this;
        }
        ...
        inline GroundSurfaceArea& farPerpendicularAngle(const float &v) noexcept {
            m_farPerpendicularAngle = v;
            return *this;
        }
        inline float farPerpendicularAngle() const noexcept {
            return m_farPerpendicularAngle;
        }
        inline GroundSurfaceArea& farDistance(const float &v) noexcept {
            m_farDistance = v;
            return *this;
        }
...
class LIB_API AimDirection {
    ...
    public:
        ...
        inline AimDirection& zentihAngle(const float &v) noexcept {
            m_zentihAngle = v;
            return *this;
        }
        inline float zentihAngle() const noexcept {
